...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên", "Email", "Số điện thoại", "Địa chỉ", "Câu hỏi bảo mật", "Trạng thái"
            }
        ));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 710, -1, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (status.equals("true")) 
            ...
            status = "true";
        int a = JOptionPane.showConfirmDialog(null,"Bạn có muốn thay đổi trạng thái của "+email+"","Thông báo",JOptionPane.YES_NO_OPTION);
        if(a == 0){
